...
{
    //通用写卡对象
    public class GeneralICCard : CustomTypeHelper, IAsyncObject
    {
        private static Log Log = Log.GetInstance("Com.Aote.ObjectTools.GeneralICCard");
        ...
        public string Kmm
        {
            ...
            {
                this.kmm = value;
                Log.Debug("kmm begin change=" + Kmm);
                OnPropertyChanged("Kmm");
                Log.Debug("kmm begin end changed=" + Kmm);
            }
        }
        ...
        public static readonly DependencyProperty CanSellGasProperty =
            DependencyProperty.Register("CanSellGas", typeof(bool), typeof(GeneralICCard),
        ...
        public static readonly DependencyProperty CanRewriteCardProperty =
            DependencyProperty.Register("CanRewriteCard", typeof(bool), typeof(GeneralICCard),
        ...
        //    DependencyProperty.Register("State", typeof(State), typeof(GeneralICCard), null);
